...
@Data
@Entity
@Table(name = "account_summary_history_argentina")
public class AccountSummaryDetailsHistoryArgentinaDao {
    ...
    private String mpa;
    @Column(name = "mpaFlag")
    private String mpaFlag;
    @Column(name = "largeFormatStatus")
    private String largeFormatStatus;
    @Column(name = "largeFormatStatusFlag")
    private String largeFormatStatusFlag;
