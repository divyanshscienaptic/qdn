...
public class DataController {
	 ...
	 * e.printStackTrace(); info.setOperationCode(500); log.error("Exception :: "
	...
	@GetMapping(value = "/getAllRecordsForPeru")
	public @ResponseBody RestListInfo<AccountSummaryDetailsPeruDao> getAllRecordsForPeru() {

		RestListInfo<AccountSummaryDetailsPeruDao> info = new RestListInfo<AccountSummaryDetailsPeruDao>();

		try {
			List<AccountSummaryDetailsPeruDao> status = dataService.getAllPeruRecords();
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@PostMapping(value = "/getFilteredRecordsForPeru")
	public @ResponseBody RestListInfo<AccountSummaryDetailsPeruDao> getFilteredRecordsForPeru(
			@RequestBody AccountSummaryFilterDetails asfd)
			throws com.hp.QppColumbia.services.exception.WebappException {

		RestListInfo<AccountSummaryDetailsPeruDao> info = new RestListInfo<AccountSummaryDetailsPeruDao>();
		try {
			List<AccountSummaryDetailsPeruDao> status = dataService
					.getAllFilteredRecordsForPeru(asfd);
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	// TODO: test
	@PostMapping(value = "/editRecordDetailsForPeru")
	public @ResponseBody boolean editRecordDetailsForPeru(@RequestBody EditASDetails editASDetails)
			throws com.hp.QppColumbia.services.exception.WebappException {

		RestListInfo<AccountSummaryDetailsPeruDao> info = new RestListInfo<AccountSummaryDetailsPeruDao>();
		try {
			boolean status = dataService.editRecordForPeru(editASDetails);
			return status;
		} catch (Exception e) {
			e.printStackTrace();
			log.error("Exception :: " + e.getMessage());
	...
	@PostMapping(value = "/getHistoryDetailsForPeru")
	public @ResponseBody RestListInfo<AccountSummaryDetailsHistoryPeruDao> getHistoryDetailsForPeru(
			@RequestBody HomoName homologatedName) {

		RestListInfo<AccountSummaryDetailsHistoryPeruDao> info = new RestListInfo<AccountSummaryDetailsHistoryPeruDao>();

		try {
			List<AccountSummaryDetailsHistoryPeruDao> status = dataService.getAllHistoryRecordsForPeru(homologatedName.getHomologatedName());
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@GetMapping(value = "/getAllHistoryDetailsForPeru")
	public @ResponseBody RestListInfo<AccountSummaryDetailsHistoryPeruDao> getAllHistoryDetailsForPeru() {

		RestListInfo<AccountSummaryDetailsHistoryPeruDao> info = new RestListInfo<AccountSummaryDetailsHistoryPeruDao>();

		try {
			List<AccountSummaryDetailsHistoryPeruDao> status = dataService.getAllTheHistoryRecordsForPeru();
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@GetMapping(value = "/getFilterDetailsForPeru")
	public RestListInfo<ASFilterResponse> getFilterDetailsForPeru() {
		RestListInfo<ASFilterResponse> info = new RestListInfo<ASFilterResponse>();

		try {
			List<ASFilterResponse> status = new ArrayList(Arrays.asList(dataService.getFilterDetailsForPeru()));
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@ApiOperation(value = "Add Bulk Record Details For Peru")
	@PostMapping(value = "/uploadRecordsForPeru")
	public @ResponseBody String uploadRecordsForPeru(@RequestParam(value = "file", required = false) MultipartFile file,
											  @RequestParam(value = "submittedBy", required = false) String submittedBy,
											  @RequestParam(value = "submittedOn", required = false) String submittedOn,
											  @RequestParam(value = "comment", required = false) String comment)
			throws JsonMappingException, JsonProcessingException {
		...
		ObjectMapper mapper = new ObjectMapper();
		try {
			String response = dataService.uploadRecordsForPeru(file, submittedBy, submittedOn, comment);
			return response;
		} catch (Exception e) {
			e.printStackTrace();
	...
	@ApiOperation(value = "Add Bulk Record Details For Peru")
	@PostMapping(value = "/getRecordDetailsForPeru")
	public @ResponseBody RestListInfo<AccountSummaryDetailsPeruDao> getRecordDetailsForPeru(
			@RequestBody HomoName homologatedName) {
		RestListInfo<AccountSummaryDetailsPeruDao> status = new RestListInfo<>();
		ObjectMapper mapper = new ObjectMapper();
		try {
			List<AccountSummaryDetailsPeruDao> accountSummaryDetailsDao = new ArrayList<AccountSummaryDetailsPeruDao>(
					Arrays.asList(dataService.getRecordDetailsForPeru(homologatedName.getHomologatedName())));
			status.setData(accountSummaryDetailsDao);
			status.setMessage("Success!");
			status.setOperationCode(200);
			return status;
	...
	@GetMapping(value = "/getAllRecordsForArgentina")
	public @ResponseBody RestListInfo<AccountSummaryDetailsArgentinaDao> getAllRecordsForArgentina() {

		RestListInfo<AccountSummaryDetailsArgentinaDao> info = new RestListInfo<AccountSummaryDetailsArgentinaDao>();

		try {
			List<AccountSummaryDetailsArgentinaDao> status = dataService.getAllArgentinaRecords();
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@PostMapping(value = "/getFilteredRecordsForArgentina")
	public @ResponseBody RestListInfo<AccountSummaryDetailsArgentinaDao> getFilteredRecordsForArgentina(
			@RequestBody AccountSummaryFilterDetails asfd)
			throws com.hp.QppColumbia.services.exception.WebappException {

		RestListInfo<AccountSummaryDetailsArgentinaDao> info = new RestListInfo<AccountSummaryDetailsArgentinaDao>();
		try {
			List<AccountSummaryDetailsArgentinaDao> status = dataService
					.getAllFilteredRecordsForArgentina(asfd);
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	// TODO: test
	@PostMapping(value = "/editRecordDetailsForArgentina")
	public @ResponseBody boolean editRecordDetailsForArgentina(@RequestBody EditASDetails editASDetails)
			throws com.hp.QppColumbia.services.exception.WebappException {

		RestListInfo<AccountSummaryDetailsArgentinaDao> info = new RestListInfo<AccountSummaryDetailsArgentinaDao>();
		try {
			boolean status = dataService.editRecordForArgentina(editASDetails);
			return status;
		} catch (Exception e) {
			e.printStackTrace();
			log.error("Exception :: " + e.getMessage());
	...
	@PostMapping(value = "/getHistoryDetailsForArgentina")
	public @ResponseBody RestListInfo<AccountSummaryDetailsHistoryArgentinaDao> getHistoryDetailsForArgentina(
			@RequestBody HomoName homologatedName) {

		RestListInfo<AccountSummaryDetailsHistoryArgentinaDao> info = new RestListInfo<AccountSummaryDetailsHistoryArgentinaDao>();

		try {
			List<AccountSummaryDetailsHistoryArgentinaDao> status = dataService.getAllHistoryRecordsForArgentina(homologatedName.getHomologatedName());
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@GetMapping(value = "/getAllHistoryDetailsForArgentina")
	public @ResponseBody RestListInfo<AccountSummaryDetailsHistoryArgentinaDao> getAllHistoryDetailsForArgentina() {

		RestListInfo<AccountSummaryDetailsHistoryArgentinaDao> info = new RestListInfo<AccountSummaryDetailsHistoryArgentinaDao>();

		try {
			List<AccountSummaryDetailsHistoryArgentinaDao> status = dataService.getAllTheHistoryRecordsForArgentina();
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@GetMapping(value = "/getFilterDetailsForArgentina")
	public RestListInfo<ASFilterResponse> getFilterDetailsForArgentina() {
		RestListInfo<ASFilterResponse> info = new RestListInfo<ASFilterResponse>();

		try {
			List<ASFilterResponse> status = new ArrayList(Arrays.asList(dataService.getFilterDetailsForArgentina()));
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@ApiOperation(value = "Add Bulk Record Details For Argentina")
	@PostMapping(value = "/uploadRecordsForArgentina")
	public @ResponseBody String uploadRecordsForArgentina(@RequestParam(value = "file", required = false) MultipartFile file,
													 @RequestParam(value = "submittedBy", required = false) String submittedBy,
													 @RequestParam(value = "submittedOn", required = false) String submittedOn,
													 @RequestParam(value = "comment", required = false) String comment)
			throws JsonMappingException, JsonProcessingException {
		...
		ObjectMapper mapper = new ObjectMapper();
		try {
			String response = dataService.uploadRecordsForArgentina(file, submittedBy, submittedOn, comment);
			return response;
		} catch (Exception e) {
			e.printStackTrace();
	...
	@ApiOperation(value = "Add Bulk Record Details For Argentina")
	@PostMapping(value = "/getRecordDetailsForArgentina")
	public @ResponseBody RestListInfo<AccountSummaryDetailsArgentinaDao> getRecordDetailsForArgentina(
			@RequestBody HomoName homologatedName) {
		RestListInfo<AccountSummaryDetailsArgentinaDao> status = new RestListInfo<>();
		ObjectMapper mapper = new ObjectMapper();
		try {
			List<AccountSummaryDetailsArgentinaDao> accountSummaryDetailsDao = new ArrayList<AccountSummaryDetailsArgentinaDao>(
					Arrays.asList(dataService.getRecordDetailsForArgentina(homologatedName.getHomologatedName())));
			status.setData(accountSummaryDetailsDao);
			status.setMessage("Success!");
			status.setOperationCode(200);
			return status;
	...
	@GetMapping(value = "/getAllRecordsForChile")
	public @ResponseBody RestListInfo<AccountSummaryDetailsChileDao> getAllRecordsForChile() {

		RestListInfo<AccountSummaryDetailsChileDao> info = new RestListInfo<AccountSummaryDetailsChileDao>();

		try {
			List<AccountSummaryDetailsChileDao> status = dataService.getAllChileRecords();
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@PostMapping(value = "/getFilteredRecordsForChile")
	public @ResponseBody RestListInfo<AccountSummaryDetailsChileDao> getFilteredRecordsForChile(
			@RequestBody AccountSummaryFilterDetails asfd)
			throws com.hp.QppColumbia.services.exception.WebappException {

		RestListInfo<AccountSummaryDetailsChileDao> info = new RestListInfo<AccountSummaryDetailsChileDao>();
		try {
			List<AccountSummaryDetailsChileDao> status = dataService
					.getAllFilteredRecordsForChile(asfd);
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	// TODO: test
	@PostMapping(value = "/editRecordDetailsForChile")
	public @ResponseBody boolean editRecordDetailsForChile(@RequestBody EditASDetails editASDetails)
			throws com.hp.QppColumbia.services.exception.WebappException {

		RestListInfo<AccountSummaryDetailsChileDao> info = new RestListInfo<AccountSummaryDetailsChileDao>();
		try {
			boolean status = dataService.editRecordForChile(editASDetails);
			return status;
		} catch (Exception e) {
			e.printStackTrace();
			log.error("Exception :: " + e.getMessage());
	...
	@PostMapping(value = "/getHistoryDetailsForChile")
	public @ResponseBody RestListInfo<AccountSummaryDetailsHistoryChileDao> getHistoryDetailsForChile(
			@RequestBody HomoName homologatedName) {

		RestListInfo<AccountSummaryDetailsHistoryChileDao> info = new RestListInfo<AccountSummaryDetailsHistoryChileDao>();

		try {
			List<AccountSummaryDetailsHistoryChileDao> status = dataService.getAllHistoryRecordsForChile(homologatedName.getHomologatedName());
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@GetMapping(value = "/getAllHistoryDetailsForChile")
	public @ResponseBody RestListInfo<AccountSummaryDetailsHistoryChileDao> getAllHistoryDetailsForChile() {

		RestListInfo<AccountSummaryDetailsHistoryChileDao> info = new RestListInfo<AccountSummaryDetailsHistoryChileDao>();

		try {
			List<AccountSummaryDetailsHistoryChileDao> status = dataService.getAllTheHistoryRecordsForChile();
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@GetMapping(value = "/getFilterDetailsForChile")
	public RestListInfo<ASFilterResponse> getFilterDetailsForChile() {
		RestListInfo<ASFilterResponse> info = new RestListInfo<ASFilterResponse>();

		try {
			List<ASFilterResponse> status = new ArrayList(Arrays.asList(dataService.getFilterDetailsForChile()));
			info.setOperationCode(200);
			info.setData(status);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@ApiOperation(value = "Add Bulk Record Details For Chile")
	@PostMapping(value = "/uploadRecordsForChile")
	public @ResponseBody String uploadRecordsForChile(@RequestParam(value = "file", required = false) MultipartFile file,
														  @RequestParam(value = "submittedBy", required = false) String submittedBy,
														  @RequestParam(value = "submittedOn", required = false) String submittedOn,
														  @RequestParam(value = "comment", required = false) String comment)
			throws JsonMappingException, JsonProcessingException {
		...
		ObjectMapper mapper = new ObjectMapper();
		try {
			String response = dataService.uploadRecordsForChile(file, submittedBy, submittedOn, comment);
			return response;
		} catch (Exception e) {
			e.printStackTrace();
			log.error("Exception :: " + e.getMessage());
	...
	@ApiOperation(value = "Add Bulk Record Details For Chile")
	@PostMapping(value = "/getRecordDetailsForChile")
	public @ResponseBody RestListInfo<AccountSummaryDetailsChileDao> getRecordDetailsForChile(
			@RequestBody HomoName homologatedName) {
		RestListInfo<AccountSummaryDetailsChileDao> status = new RestListInfo<>();
		ObjectMapper mapper = new ObjectMapper();
		try {
			List<AccountSummaryDetailsChileDao> accountSummaryDetailsDao = new ArrayList<AccountSummaryDetailsChileDao>(
					Arrays.asList(dataService.getRecordDetailsForChile(homologatedName.getHomologatedName())));
			status.setData(accountSummaryDetailsDao);
			status.setMessage("Success!");
			status.setOperationCode(200);
			return status;
	...
	@GetMapping(value = "/get-chile-data")
	public List<AccountSummaryDetailsDao> getAllChileRecords(){
		return dataService.getAllRecords();
	}

	@PostMapping(value = "/add-seller-for-chile")
	public List<AccountSummaryDetailsDao> addSellerToChile(@RequestBody List<AddAccountSummaryDAO> sellers){
		return dataService.addSellerToChile(sellers);
	}
	/*
	 ...
	 * info.setOperationCode(500); log.error("Exception :: " + e.getMessage()); }
	 * 
	 * }
	 * 
	 ...
	 * catch (Exception e) { e.printStackTrace(); log.error("Exception :: " +
	 * e.getMessage()); } return false; }
	 * 
	 ...
	 * (Exception e) { e.printStackTrace(); log.error("Exception :: " +
	 * e.getMessage()); } return false; }
	 * 
	 ...
	 * info.setData(status); } catch (Exception e) { e.printStackTrace();
	 * log.error("Exception :: " + e.getMessage()); info.setOperationCode(500); }
	 * System.out.println("ended Controller"); return info; }
	 * 
	 ...
	 * info.setOperationCode(200); info.setData(status); } catch (Exception e) {
	 * e.printStackTrace(); log.error("Exception :: " + e.getMessage());
	 ...
	 * log.error("Exception :: " + e.getMessage()); } return false; }
	 * 
	 ...
	 * e) { e.printStackTrace(); log.error("Exception :: " + e.getMessage()); }
	 * return false; }
	 * 
	 ...
	 * log.error("Exception :: " + e.getMessage()); } return info;
	 * 
	 * }
	 * 
